import math
def paginate(org_id, current_page_number, max_record_per_page, total_records, baseURL, taxonomy_id = ""):
    ...
    remaining_record_after_pagination = total_records - (page_number * max_record_per_page)
    if taxonomy_id !="":
        ...
        if remaining_record_after_pagination > 0:
            pagingURL['next_page']  = baseURL.format(org_id = org_id, page_index=page_number + 1)
