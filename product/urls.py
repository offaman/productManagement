...
urlpatterns = [
    ...
    path('addtaxonomy',views.taxonomies, name = 'taxonomy'),
    ...
    path('removefieldfromtaxonomy', views.dis_associate_field_from_taxonomy),
    path('associatefield', views.associate_field_to_taxonomy)
]
# urlpatterns = [
